...
{
    public partial class devrefrigeratorContext : DbContext
    {
        public devrefrigeratorContext()
        {
        }

        public devrefrigeratorContext(DbContextOptions<devrefrigeratorContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => e.Guid)
                    .HasName("PK__Attribut__497F6CB4BC560DC7");
            ...
            {
                entity.HasKey(e => e.Guid)
                    .HasName("PK__tmp_ms_x__497F6CB42E9C9CE9");
            ...
            {
                entity.HasKey(e => e.Guid)
                    .HasName("PK__IOTConne__497F6CB4315DB40B");
