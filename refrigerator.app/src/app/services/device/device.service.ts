...
export class DeviceService {
  ...
  getdevicemaintenance(curdate,timezone) {
    return this.httpClient.post<any>(this.apiServer.baseUrl + 'api/devicemaintenance/upcoming',{
			currentDate: curdate,
			timeZone:timezone}).map(response => {
